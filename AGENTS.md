...
every green certificate (0001–0003, 0005–0025) is verified under 3.9 AND under `python3 -O` (0004 is never-green scaffolding; 0024/0025 run ~5–7 min each). "Runs under a bare python3" is a
